...
//! An interface for writable streams.
//!
...
///
/// Return the number of bytes processed, not the number of bytes written. For
/// example, a compression writer should return the number of bytes it used
