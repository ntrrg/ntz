...
test "ntz.encoding.unicode.utf8.nextValidPos" {
    ...
    try testing.expectEql(utf8.nextValidPosAt(2, in), .{ .i = 4, .j = 6 });
    try testing.expectEql(utf8.nextValidPosAt(5, in), .{ .i = 7, .j = 10 });
    try testing.expectEql(utf8.nextValidPosAt(8, in), .{ .i = 11, .j = 15 });
    try testing.expectEql(utf8.nextValidPosAt(12, in), null);
}
